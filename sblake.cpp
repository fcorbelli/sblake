/*
	...
	a straight BLAKE3 on c that compile on FreeBSD

	by Franco Corbelli
	https://github.com/fcorbelli
	franco@francocorbelli.com
	
	g++ -O3 sblake.cpp -o sblake -lstdc++ -static
...
/// Nothing special
std::string blake3_calc_file(const char * i_filename)
{
...
int main(int argc,char*argv[])
{
	...
	{
		printf("Running...\n");
		std::string thehash=blake3_calc_file(argv[1]);
		printf("The hash %s\n",thehash.c_str());
	}
	else
	{
		printf("SBLAKE.cpp - plain BLAKE3 by Franco Corbelli\n");
		printf("Just a filename as parameter\n");
	}
	return 0;
}
